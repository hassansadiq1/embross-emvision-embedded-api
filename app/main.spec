...
a = Analysis(['main.py'],
             ...
             binaries=[],
             datas=[("config.json", '.'),
					('../venv/Lib/site-packages/openvino/', './openvino'),
					('../venv/Lib/site-packages/paravision_models/', './paravision_models'),
					('../venv/Lib/site-packages/passlib/handlers', './passlib/handlers'),
					],
...
coll = COLLECT(exe,
               ...
               upx=True,
               upx_exclude=[],
               name='EmvisionEmbeddedEVN-1.2.4')
